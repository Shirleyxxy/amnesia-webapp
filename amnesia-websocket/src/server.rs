...
impl Handler for Server {
    ...
    fn on_request(&mut self, req: &Request) -> Result<(Response)> {
        match req.resource() {
            ...
            "/images/Frozen.jpg" => Ok(Response::new(200, "OK", read_local("html/images/Frozen.jpg"))),
            "/images/IT.jpg" => Ok(Response::new(200, "OK", read_local("html/images/IT.jpg"))),
            "/images/Joker.jpg" => Ok(Response::new(200, "OK", read_local("html/images/Joker.jpg"))),
            "/images/Midway.jpg" => Ok(Response::new(200, "OK", read_local("html/images/Midway.jpg"))),
